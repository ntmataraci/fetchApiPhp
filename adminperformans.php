...
<form method="post" autocomplete="off">
  ...
  <div class="form-col">
    ...
    <input list="livesearch" class="form-control" id="adress" placeholder="Kullanıcı Adını Girin" name="username" onkeyup="liveSearch('userperformans')" value=""></input>
    <datalist id="livesearch">
  </div>
  <button  class="btn btn-primary" onclick="getData(event,'userperformans')">Getir</button>
          </div>
...
<div class="col-md-2"> Performans:  <input type="number" class="form-control" id="myPerformans"  name="performans" ></input></div>
  <button  class="btn btn-primary" onclick="addData('userperformans')">Güncelle</button>
